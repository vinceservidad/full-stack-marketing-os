...
| `strategy-template.md` | owned | `$growth-strategy` (linked from SKILL.md) — cross-functional growth-system, constraint, opportunity portfolio, sequencing, non-priority, measurement, and review record |
| `README.md` | consumed | Directory index |
