...
one to the governed skills that actually own the work. They contain no operating
instructions and route nothing.
...
|---|---|
| [Marketing Strategist](marketing-strategist.md) | `$marketing-router`, `$marketing-intake`, `$icp-jtbd`, `$customer-research` |
