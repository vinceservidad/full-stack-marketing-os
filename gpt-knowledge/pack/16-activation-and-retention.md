...
## Source: `.agents/skills/activation/SKILL.md`
...
Classify activation artifacts with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). An activation heuristic or common “aha moment” pattern is a hypothesis input, not evidence that a specific event predicts value or retention for this business.
...
2. **Define first meaningful value.** Use Activation definition and evidence (source: `.agents/skills/activation/references/activation-definition-and-evidence.md`). Separate customer value from business convenience and from easy-to-track onboarding events.
3. **Map the path to value.** Use Path to value and friction (source: `.agents/skills/activation/references/path-to-value-and-friction.md`). Map required steps, dependencies, wait states, handoffs, customer effort, uncertainty, and failure points.
...
7. **Define the test and guardrails.** Use Activation experiments and handoffs (source: `.agents/skills/activation/references/activation-experiments-and-handoffs.md`). Primary outcome should reflect meaningful value or a validated activation proxy; guardrails may include refund/cancellation, support burden, quality, safety/compliance, retention, and downstream revenue.
...
- activation-plan.md (source: `templates/activation-plan.md`) — canonical activation definition, journey, diagnosis, intervention, measurement, and learning record.
...
## Source: `.agents/skills/activation/references/activation-definition-and-evidence.md`
...
## Source: `.agents/skills/activation/references/activation-experiments-and-handoffs.md`
...
## Source: `.agents/skills/activation/references/path-to-value-and-friction.md`
...
## Source: `.agents/skills/retention-strategy/SKILL.md`
...
Classify outputs with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). A churn reason, save tactic, win-back pattern, or retention benchmark is a hypothesis input until supported in this business and segment.
...
3. **Diagnose the cause.** Use Retention diagnosis and reason coding (source: `.agents/skills/retention-strategy/references/retention-diagnosis-and-reason-coding.md`). Separate customer-stated reason, observed behavior, operational facts, commercial terms, and inference.
4. **Match intervention to cause.** Use Intervention selection and save/recovery (source: `.agents/skills/retention-strategy/references/intervention-selection-and-save-recovery.md`). Fix defects before persuading; handle failed payment differently from poor fit, price objection, low need, service failure, or unmet promise.
5. **Choose the correct lifecycle objective.** Retention of an active customer, cancellation save, failed-payment recovery, repeat-purchase support, lapse prevention, and win-back are different decisions. Use Repeat, renewal, and win-back (source: `.agents/skills/retention-strategy/references/repeat-renewal-and-winback.md`).
...
- retention-strategy-plan.md (source: `templates/retention-strategy-plan.md`) — canonical diagnosis, intervention, save/recovery, win-back, measurement, and learning record.
...
## Source: `.agents/skills/retention-strategy/references/intervention-selection-and-save-recovery.md`
...
## Source: `.agents/skills/retention-strategy/references/repeat-renewal-and-winback.md`
...
## Source: `.agents/skills/retention-strategy/references/retention-diagnosis-and-reason-coding.md`
...
## Source: `.agents/skills/retention-economics/SKILL.md`
...
Classify each model, curve, or projection with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). A cohort curve is a pattern from observed customers, not a guarantee for future ones. A projected lifetime value is a model output, not a business outcome, until realized revenue confirms it.
...
Read Customer lifetime value (source: `.agents/skills/retention-economics/references/customer-lifetime-value.md`) for LTV method and pitfalls. Read Payback period (source: `.agents/skills/retention-economics/references/payback-period.md`) for acquisition payback. Read Cohort and retention analysis (source: `.agents/skills/retention-economics/references/cohort-and-retention-analysis.md`) for curve construction and retention/churn. Read Lead-to-revenue cohorts (source: `.agents/skills/retention-economics/references/lead-to-revenue-cohorts.md`) for lead-generation and long sales-cycle businesses.
...
## Source: `.agents/skills/retention-economics/references/cohort-and-retention-analysis.md`
...
## Source: `.agents/skills/retention-economics/references/customer-lifetime-value.md`
...
## Source: `.agents/skills/retention-economics/references/lead-to-revenue-cohorts.md`

# Lead-to-Revenue Cohorts

Extends cohort economics to lead generation and long sales-cycle businesses, where the gap between marketing conversion and realized revenue can be weeks or quarters. Read alongside Cohort and retention analysis (source: `.agents/skills/retention-economics/references/cohort-and-retention-analysis.md`).
...
## Source: `.agents/skills/retention-economics/references/payback-period.md`
