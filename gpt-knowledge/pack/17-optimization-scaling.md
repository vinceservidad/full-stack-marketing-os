...
## Source: `.agents/skills/optimization-scaling/SKILL.md`
...
Primary knowledge type: methodology. Classify supporting models, strategies, tactics, techniques, templates, heuristics, and evidence with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`).
...
1. Apply the proof standard (source: `.agents/skills/optimization-scaling/references/proof-standard.md`) and label current evidence.
2. Run the readiness gates (source: `.agents/skills/optimization-scaling/references/readiness.md`). Stop when a verified blocker makes scaling unsafe.
3. Model economics and marginal efficiency (source: `.agents/skills/optimization-scaling/references/economics.md`); expose missing inputs and sensitivity ranges.
4. Diagnose the binding constraint and select a scaling mode using constraints and modes (source: `.agents/skills/optimization-scaling/references/constraints-and-modes.md`).
...
6. Use controlled steps (source: `.agents/skills/optimization-scaling/references/controlled-steps.md`) to test, wait for maturity, evaluate marginal business outcome, and decide `increase`, `hold`, `continue evidence`, `apply`, `rollback`, `switch mode`, `de-scale`, or `inconclusive`.
7. Verify the result against the business source of truth and record scope, proof level, exceptions, and replication status.

Read only the relevant conditional reference: portfolio allocation (source: `.agents/skills/optimization-scaling/references/portfolio-allocation.md`), creative capacity (source: `.agents/skills/optimization-scaling/references/creative-capacity.md`), Google Ads (source: `.agents/skills/optimization-scaling/references/google-scaling.md`), Meta Ads (source: `.agents/skills/optimization-scaling/references/meta-scaling.md`), business-model overlays (source: `.agents/skills/optimization-scaling/references/business-overlays.md`), guardrails and recovery (source: `.agents/skills/optimization-scaling/references/guardrails-and-recovery.md`), or budget and outcome pacing (source: `.agents/skills/optimization-scaling/references/budget-and-outcome-pacing.md`) when spend or outcome is off an already-approved plan within the current period. For current platform controls, apply `PLATFORM-CURRENCY.md` and confirm account visibility.
...
## Source: `.agents/skills/optimization-scaling/references/budget-and-outcome-pacing.md`
...
## Source: `.agents/skills/optimization-scaling/references/business-overlays.md`
...
## Source: `.agents/skills/optimization-scaling/references/constraints-and-modes.md`
...
## Source: `.agents/skills/optimization-scaling/references/controlled-steps.md`
...
## Source: `.agents/skills/optimization-scaling/references/creative-capacity.md`
...
## Source: `.agents/skills/optimization-scaling/references/economics.md`
...
## Source: `.agents/skills/optimization-scaling/references/google-scaling.md`
...
## Source: `.agents/skills/optimization-scaling/references/guardrails-and-recovery.md`
...
## Source: `.agents/skills/optimization-scaling/references/meta-scaling.md`
...
## Source: `.agents/skills/optimization-scaling/references/portfolio-allocation.md`
...
## Source: `.agents/skills/optimization-scaling/references/proof-standard.md`
...
Credible incrementality evidence means a graded causal result, not platform attribution. S4 requires a controlled comparison at C3 or above on the causal evidence ladder (source: `.agents/skills/tracking-measurement/references/causal-evidence-ladder.md`); `$tracking-measurement` owns method selection and grading. Platform-attributed performance is C0 and cannot raise a claim above S3 regardless of volume or consistency.

## Source: `.agents/skills/optimization-scaling/references/readiness.md`
