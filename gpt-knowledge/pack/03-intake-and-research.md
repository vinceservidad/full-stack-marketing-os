...
**Use when:** Capture and grade the evidence, metric definitions, access, authorization, and reusable project context behind a marketing engagement before substantial audit, diagnosis, planning, or scaling work; use when scope, data provenance, economics, shared context, or approval boundaries are unclear.
...
9. When the project needs reusable cross-skill context, create or update `.agents/marketing-context.md` from `templates/marketing-context.md` using Marketing Context governance. Preserve provenance, evidence state, contradictions, freshness, and the change log; do not copy unnecessary raw data into it.
...
- `templates/marketing-context.md` — reusable structure for project-level shared Marketing Context.
- Marketing Context governance — creation, update, freshness, contradiction, and ownership rules.
...
### Reference: marketing context governance ($marketing-intake)

### Marketing Context Governance

Use this reference when creating, updating, or relying on a project-level `.agents/marketing-context.md` built from `templates/marketing-context.md`.
...
5. When reviews are a material source for creative or messaging decisions, read Review mining for creative research. Include positive, neutral, and negative evidence and preserve contradictions rather than treating positive reviews as the default truth set.
...
### Reference: review mining for creative ($customer-research)
...
Classify this as a research methodology under `KNOWLEDGE-TAXONOMY.md`. Reviews are stated customer experiences. They can reveal language and patterns, but they do not by themselves verify product causality, prevalence, or generalizable outcomes.
...
**Use when:** Define or refine ideal-customer segments, Jobs-to-be-Done, and decision-relevant competitive alternatives from verified commercial, customer, and market evidence; use for targeting and positioning choices, not fictional personas or tactic copying.

Classify segment and competitive outputs with `KNOWLEDGE-TAXONOMY.md`: model, methodology, process, pattern, hypothesis, or strategy. Do not turn a research pattern, competitor observation, or market estimate into a universal segment truth.
...
5. When the decision depends on competitors or category structure, map direct, different-solution, internal/manual, and status-quo alternatives using Competitive Intelligence. Keep competitor facts, customer evidence, market estimates, inferences, and strategic implications separate.
...
- Competitive Intelligence — alternatives, competitor snapshots, evidence separation, change tracking, and strategic implications.
...
### Reference: competitive intelligence ($icp-jtbd)
