...
## Source: `.agents/skills/cro/SKILL.md`
...
Classify each deliverable with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). Heuristic observations are hypothesis inputs, not causal findings or universal best practices.
...
- shopify-cro.md (source: `frameworks/shopify-cro.md`) — Shopify-specific conversion framework.
- ecommerce.md (source: `playbooks/ecommerce.md`) — ecommerce conversion playbook.
- ecommerce-growth.md (source: `playbooks/ecommerce-growth.md`) — ecommerce growth playbook.
- landing-page-review.md (source: `templates/landing-page-review.md`) — landing page review format.
- cro-improvement.md (source: `workflows/cro-improvement.md`) — improvement workflow sequence.
...
## Source: `.agents/skills/offer-strategy/SKILL.md`
...
Classify each offer artifact with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). Offer patterns and direct-response frameworks are hypothesis inputs, not proof that a specific audience will buy.
...
3. **Audit value architecture.** Use Offer architecture (source: `.agents/skills/offer-strategy/references/offer-architecture.md`) to inspect outcome relevance, confidence/proof, time-to-value, buyer effort, friction, completeness, and economic feasibility.
4. **Diagnose the binding offer constraint.** Identify the weakest decision-relevant component instead of rebuilding everything by default. See Offer diagnosis (source: `.agents/skills/offer-strategy/references/offer-diagnosis.md`).
...
6. **Audit risk reversal and urgency.** Use Risk reversal and urgency (source: `.agents/skills/offer-strategy/references/risk-reversal-and-urgency.md`). A guarantee must transfer a real risk the business can bear. Urgency or scarcity must be true, specific, and operationally enforceable.
...
## Source: `.agents/skills/offer-strategy/references/offer-architecture.md`
...
## Source: `.agents/skills/offer-strategy/references/offer-diagnosis.md`
...
## Source: `.agents/skills/offer-strategy/references/risk-reversal-and-urgency.md`
...
## Source: `.agents/skills/pricing-monetization/SKILL.md`
...
Classify pricing outputs with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). A pricing framework or benchmark is a hypothesis input, not evidence that a specific price is optimal.
...
2. **Define the economic floor and operating constraints.** Use Pricing architecture (source: `.agents/skills/pricing-monetization/references/pricing-architecture.md`) to identify variable cost, cost-to-serve, contribution target, capacity, refund/cancellation risk, and any channel or payment costs that materially change economics.
...
4. **Assess evidence on price sensitivity.** Use Willingness-to-pay evidence (source: `.agents/skills/pricing-monetization/references/willingness-to-pay-evidence.md`). Separate observed purchases and behavioral tests from stated survey answers, sales anecdotes, competitor prices, and model inference.
...
7. **Choose the smallest decision-valid test.** Use Price-change testing and rollout (source: `.agents/skills/pricing-monetization/references/price-change-testing-and-rollout.md`). Specify population, eligibility, treatment, primary business outcome, guardrails, duration/lag, grandfathering or migration rules, and rollback/stop conditions.
...
- pricing-decision.md (source: `templates/pricing-decision.md`) — canonical pricing decision, scenario, rollout, migration, and verification record.
...
## Source: `.agents/skills/pricing-monetization/references/price-change-testing-and-rollout.md`
...
## Source: `.agents/skills/pricing-monetization/references/pricing-architecture.md`
...
## Source: `.agents/skills/pricing-monetization/references/willingness-to-pay-evidence.md`
