...
## Source: `.agents/skills/tracking-measurement/SKILL.md`
...
Classify architecture maps, models, methodologies, processes, checklists, experiment results, and recommendations with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). Keep a collection defect, attribution difference, business-performance change, experimental estimate, and reusable learning as distinct evidence categories.
...
8. When an experiment concludes, validate execution before reading direction, classify the result, separate observed effect from mechanism interpretation, and create a scoped learning record using Experiment Learning System (source: `.agents/skills/tracking-measurement/references/experiment-learning-system.md`) and `templates/experiment-learning.md` (source: `templates/experiment-learning.md`).
...
- Event-level QA: event integrity (source: `.agents/skills/tracking-measurement/references/event-integrity.md`).
- Totals differ across platforms or business systems: attribution reconciliation (source: `.agents/skills/tracking-measurement/references/attribution-reconciliation.md`).
- Grading how strongly evidence supports a causal claim: causal evidence ladder (source: `.agents/skills/tracking-measurement/references/causal-evidence-ladder.md`).
- Choosing how to measure incremental effect: incrementality method selector (source: `.agents/skills/tracking-measurement/references/incrementality-method-selector.md`).
- Randomized audience split: holdout experiments (source: `.agents/skills/tracking-measurement/references/holdout-experiments.md`).
- Geographic treatment and control, matched markets, synthetic control, switchback: geo experiments (source: `.agents/skills/tracking-measurement/references/geo-experiments.md`).
- Platform-native lift mechanisms: platform lift studies (source: `.agents/skills/tracking-measurement/references/platform-lift-studies.md`).
- Long-horizon cross-channel allocation: Marketing Mix Modeling (source: `.agents/skills/tracking-measurement/references/marketing-mix-modeling.md`).
- Several imperfect sources and no decisive test: triangulation (source: `.agents/skills/tracking-measurement/references/measurement-triangulation.md`).
- Turning completed tests into durable scoped knowledge and a decision-relevant backlog: Experiment Learning System (source: `.agents/skills/tracking-measurement/references/experiment-learning-system.md`).
...
- measurement-and-evidence.md (source: `frameworks/measurement-and-evidence.md`) — measurement and evidence framework.
- experimentation.md (source: `frameworks/experimentation.md`) — general experimentation framework.
- experiment.md (source: `templates/experiment.md`) — pre-test experiment brief format.
- experiment-learning.md (source: `templates/experiment-learning.md`) — post-test validity, learning, transfer, and follow-up record.
...
## Source: `.agents/skills/tracking-measurement/references/attribution-reconciliation.md`
...
## Source: `.agents/skills/tracking-measurement/references/causal-evidence-ladder.md`
...
Classify with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). A ladder position is an evidence grade, never proof of an outcome.
...
## Source: `.agents/skills/tracking-measurement/references/event-integrity.md`
...
## Source: `.agents/skills/tracking-measurement/references/experiment-learning-system.md`
...
Use `templates/experiment-learning.md` (source: `templates/experiment-learning.md`).
...
## Source: `.agents/skills/tracking-measurement/references/geo-experiments.md`
...
## Source: `.agents/skills/tracking-measurement/references/holdout-experiments.md`
...
## Source: `.agents/skills/tracking-measurement/references/incrementality-method-selector.md`
...
|---|---|---|
| Platform supports randomized user split and the audience can be held out | User-level holdout | Holdouts (source: `.agents/skills/tracking-measurement/references/holdout-experiments.md`) |
| Users cannot be split cleanly, but regions are independent and numerous enough | Geo experiment or matched-market test | Geo experiments (source: `.agents/skills/tracking-measurement/references/geo-experiments.md`) |
| Platform offers a native randomized lift mechanism and its design is acceptable | Platform lift study | Lift studies (source: `.agents/skills/tracking-measurement/references/platform-lift-studies.md`) |
| Effect is short-lived and treatment can alternate on a schedule | Switchback | Geo experiments (source: `.agents/skills/tracking-measurement/references/geo-experiments.md`) |
| No control is possible, but a comparable untreated series exists | Synthetic control or interrupted time series (C3) | Geo experiments (source: `.agents/skills/tracking-measurement/references/geo-experiments.md`) |
| Question is long-horizon cross-channel allocation, not a single change | Marketing Mix Modeling (C2) | Marketing Mix Modeling (source: `.agents/skills/tracking-measurement/references/marketing-mix-modeling.md`) |
| Several imperfect sources exist and no single test is decisive | Triangulate | Triangulation (source: `.agents/skills/tracking-measurement/references/measurement-triangulation.md`) |
...
## Source: `.agents/skills/tracking-measurement/references/marketing-mix-modeling.md`
...
## Source: `.agents/skills/tracking-measurement/references/measurement-triangulation.md`
...
## Source: `.agents/skills/tracking-measurement/references/platform-lift-studies.md`
