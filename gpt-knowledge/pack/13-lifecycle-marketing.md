...
## Source: `.agents/skills/lifecycle-marketing/SKILL.md`
...
5. Read Deliverability (source: `.agents/skills/lifecycle-marketing/references/deliverability.md`) before recommending a cadence, list-growth tactic, or content change that could affect inbox placement.
6. Read Segmentation and triggers (source: `.agents/skills/lifecycle-marketing/references/segmentation-and-triggers.md`) for segment design and trigger-condition detail.
...
## Source: `.agents/skills/lifecycle-marketing/references/deliverability.md`
...
## Source: `.agents/skills/lifecycle-marketing/references/segmentation-and-triggers.md`
