...
## Source: `.agents/skills/youtube-ads/SKILL.md`
...
2. Select ad format to fit the objective and the creative actually available. See Format selection (source: `.agents/skills/youtube-ads/references/format-selection.md`).
...
## Source: `.agents/skills/youtube-ads/references/format-selection.md`
...
## Source: `.agents/skills/youtube-ads/references/measurement-fit.md`
...
## Source: `.agents/skills/tiktok-ads/SKILL.md`
...
Classify each model, format decision, or targeting recommendation with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). TikTok's core mechanic — an algorithmic feed that rewards content viewers do not perceive as an ad — makes this a distinct discipline from Meta and YouTube, not a reskin of either. A creative asset that performs on Meta frequently underperforms on TikTok unedited, and the reverse.
...
1. Assess creative fit before targeting or budget: does the available creative read as native to the feed, or does it read as an interruption. See Native creative fit (source: `.agents/skills/tiktok-ads/references/native-creative-fit.md`).
...
4. Plan creative cadence and refresh rate to the account's actual fatigue signal — see Creative fatigue and refresh cadence (source: `.agents/skills/tiktok-ads/references/creative-fatigue-and-refresh-cadence.md`) — rather than a fixed calendar borrowed from a different platform.
...
## Source: `.agents/skills/tiktok-ads/references/creative-fatigue-and-refresh-cadence.md`
...
## Source: `.agents/skills/tiktok-ads/references/native-creative-fit.md`
