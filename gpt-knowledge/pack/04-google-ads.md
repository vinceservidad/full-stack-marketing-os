...
**Use when:** Audit, diagnose, or plan Google Ads Search, Shopping, and Performance Max work using business outcomes and query or product evidence; not for unsupported live changes.
...
Classify each audit, model, methodology, process, tactic, technique, best practice, or heuristic with `KNOWLEDGE-TAXONOMY.md`. Name the primary type and keep platform evidence separate from recommendations.
...
For substantial mode-specific work, read only the relevant reference: Search, Shopping, or Performance Max. For current AI, automation, control, reporting, or interface claims, read Platform Registry and apply the root `PLATFORM-CURRENCY.md` freshness gate.
...
- google-ads-full-stack.md — full-account decision model beyond a single audit or diagnosis.
- google-ads-audit.md — step-by-step audit workflow.
- google-ads-optimization.md — recurring optimization cadence.
- campaign-brief.md — campaign brief format, shared with $meta-ads.
...
### Reference: platform current ($google-ads)
