...
## Source: `.agents/skills/meta-ads/SKILL.md`
...
Classify each audit, strategy, process, tactic, technique, best practice, or heuristic with `KNOWLEDGE-TAXONOMY.md` (source: `KNOWLEDGE-TAXONOMY.md`). Name the primary type and keep documented platform capability separate from expected business impact.
...
- meta-ads-full-stack.md (source: `frameworks/meta-ads-full-stack.md`) — full-account decision model beyond a single audit or diagnosis.
- meta-ads-audit.md (source: `playbooks/meta-ads-audit.md`) — step-by-step audit workflow.
- meta-ads-optimization.md (source: `workflows/meta-ads-optimization.md`) — recurring optimization cadence.
- campaign-brief.md (source: `templates/campaign-brief.md`) — campaign brief format, shared with $google-ads.
...
## Source: `.agents/skills/meta-ads/references/platform-current.md`
...
## Source: `.agents/skills/meta-ads/references/prospecting.md`
...
## Source: `.agents/skills/meta-ads/references/retargeting.md`
