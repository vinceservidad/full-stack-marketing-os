...
22. Growth strategy must start from a named business outcome, baseline, horizon, constraints, and specialist evidence. Do not use a fixed 30/60/90 or 90-day roadmap, universal portfolio/budget split, mandatory channel count, experiment quota, or funnel-stage allocation as a default. Strategic portfolio priority does not bypass domain ownership, measurement validity, scaling gates, operational capacity, or live-change authorization.
