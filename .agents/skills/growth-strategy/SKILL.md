...
description: Build an evidence-led business-level marketing growth strategy by defining the commercial objective, identifying the binding constraint, prioritizing growth opportunities, sequencing specialist work, and governing a learning roadmap; not for generic channel checklists, arbitrary budget splits, or taking over specialist execution decisions.
---
...
1. **Define the growth objective.** State the primary business outcome, horizon, economic boundary, quality guardrails, and what would count as meaningful progress. Avoid vague goals such as “grow awareness” unless awareness is itself the explicitly approved objective.
...
3. **Identify the binding constraint.** Use [Growth constraint and opportunity diagnosis](references/growth-constraint-and-opportunity.md). Separate symptoms from the constraint currently limiting the business outcome.
...
9. **Define review and adaptation.** Use [Plan governance and review](references/plan-governance-and-review.md). Set context-appropriate review triggers/horizons, decision gates, and `continue`, `hold`, `kill`, `revise`, `defer`, or `route to scaling` outcomes.
...
Growth strategy: business objective and horizon; economic/quality guardrails; evidence baseline; binding constraint and confidence; opportunity set; prioritized strategic bets; explicit non-priorities; specialist owners and dependencies; sequence; learning agenda and experiments; measurement owner; capacity/resource implications; review triggers and decision gates; scaling handoff where applicable; unknowns/contradictions; exact status.
...
Confirm the objective is commercial or explicitly approved, the constraint is evidence-based rather than assumed, opportunities are not channel-first defaults, priorities fit capacity, specialist ownership is preserved, non-priorities are explicit, forecasts are not guarantees, experiments have decision rules and guardrails, scaling is handed to `$optimization-scaling`, and no draft plan is described as implemented or successful.
