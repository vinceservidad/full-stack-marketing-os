...
3. Set posting cadence and community-management expectations against actual production and response capacity; an unsustainable cadence degrades both content quality and response time, and a plan that cannot be sustained is not a plan. See [Cadence and community management](references/cadence-and-community-management.md).
