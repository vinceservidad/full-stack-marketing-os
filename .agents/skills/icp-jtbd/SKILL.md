...
Classify segment and competitive outputs with [`KNOWLEDGE-TAXONOMY.md`](../../../KNOWLEDGE-TAXONOMY.md): model, methodology, process, pattern, hypothesis, or strategy. Do not turn a research pattern, competitor observation, or market estimate into a universal segment truth.
